    ...
    >
      ...
      >
        <Box sx={{
          ...
          <Box sx={{ textAlign: 'left', maxWidth: { xs: '100%', md: '50%' } }}>
            ...
            >
              Tasker helps teams move work forward.
            </Typography>
            <Typography
              variant="h5"
              sx={{
      ...
      <Box
        ...
        sx={{
          ...
          borderTop: isDarkMode ? '4px solid #333333' : '4px solid #cccccc', 
          ...
          <Grid container spacing={4}>
            <Grid item xs={12} sm={4}>
              ...
              >
                <iframe
                  title="Find Us Map"
                  src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d2565.6128503321997!2d10.678735810598214!3d36.43660875914298!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e1!3m2!1sfr!2stn!4v1734728718810!5m2!1sfr!2stn"
                  width="100%"
                  height="200"
                  style={{ border: 0 }}
                  allowFullScreen=""
            ...
            <Grid item xs={12} sm={4}>
              ...
              <Typography variant="body2" sx={{ opacity: 0.9, lineHeight: 1.6 }}>
                <strong>Phone:</strong> +216 26 676 861
              </Typography>
              <Typography variant="body2" sx={{ opacity: 0.9, lineHeight: 1.6 }}>
                <strong>Email:</strong>{' '}
                <a
                  href="mailto:oussemabenslimene@gmail.com"
                  style={{
                    color: isDarkMode ? '#f0a500' : '#f57c00',
                    textDecoration: 'none',
                  }}
                >
                  oussemabenslimene@gmail.com
                </a>
              </Typography>
            </Grid>
            ...
            <Grid item xs={12} sm={4}>
              ...
              >
                ...
                <IconButton
                  href="https://www.linkedin.com/in/bellili-hamza-b01a01318"
                  target="_blank"
                  sx={{
                ...
                <IconButton
                  href="https://github.com/OussemaBenslimene"
                  target="_blank"
                  sx={{
                    color: isDarkMode ? '#e0e0e0' : '#333333',
                    '&:hover': { color: '#0A66C2' },
